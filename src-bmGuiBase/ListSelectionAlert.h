...
public:
	ListSelectionAlert(const char* title, const char* info_text, BList& items,
		const char* initial_selection, const char* button_0_label,
		const char* button_1_label = NULL, float min_list_box_width = 250,
		int min_list_box_height = 100, button_width width_style = B_WIDTH_AS_USUAL,
