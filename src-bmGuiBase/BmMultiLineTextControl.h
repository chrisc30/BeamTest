...
class IMPEXPBMGUIBASE BmMultiLineTextControl : public MView,
...
public:
	...
	BmMultiLineTextControl(const char* label, bool labelIsMenu = false, int32 lineCount = 4,
		int32 minTextLen = 0, bool fixedHeight = false);
