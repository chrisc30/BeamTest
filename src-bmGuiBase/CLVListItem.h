...
public:
	...
	*/
	...
	virtual void DrawColumn(BRect item_column_rect, int32 column_index, CLVDrawingContext* ctx) = 0;
	...
	inline void SetSuperItem(bool superitem) { SetStyleFlag(CLV_STYLE_SUPERITEM, superitem); }
	...
	static void SetDefaultExpanderBitmaps(BmBitmapHandle* expanded, BmBitmapHandle* unexpanded);
