...
//******************************************************************************************************
typedef int (*CLVCompareFuncPtr)(
	const CLVListItem* item1, const CLVListItem* item2, int32 sort_key, int32 col_flags);
...
public:
	...
	ColumnListView(BRect Frame, const char* Name = NULL,
	...
	{
		if (window_active)
			fSelectedItemColorWindowActive = color;
		else
			fSelectedItemColorWindowInactive = color;
	}
	...
	{
		if (fWindowActive)
			return fSelectedItemColorTintedWindowActive;
...
protected:
	...
	virtual BetterScrollView* ScrollView() { return fScrollView; }
