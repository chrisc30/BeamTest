...
BubbleHelper::BubbleInfo*
BubbleHelper::FindInfo(BView* view)
{
	BubbleInfo* info;
...
void
BubbleHelper::SetCursor(BView* view, const BCursor* cursor)
{
	if (view) {
		infoLocker->Lock();
		BubbleInfo* info = FindInfo(view);
...
void
BubbleHelper::DropInfo(BView* view)
{
	if (view) {
		infoLocker->Lock();
		BubbleInfo* info = FindInfo(view);
...
const BCursor*
BubbleHelper::GetCursor(BView* view)
{
...
void
BubbleHelper::DisplayHelp(const char* text, BPoint where)
{
