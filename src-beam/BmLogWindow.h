...
public:
	...
	static BmLogWindow* CreateAndStartInstanceFor(
		const char* logfileName, bool showUponNews = false, bool clingToMainWin = false);
	BmLogWindow(const BRect& frame, const BmString& title, const char* logfileName,
