...
char* get_address(address_part_t addrpart, void** data, void** marker, int canon_domain);
...
int do_vacation(
	action_list_t* m, char* addr, char* fromaddr, char* subj, char* msg, int days, int mime);
...
int do_notify(notify_list_t* n, char* id, char* method, stringlist_t** options,
	const char* priority, char* message);
int do_denotify(notify_list_t* n, comparator_t* comp, void* pat, const char* priority);
