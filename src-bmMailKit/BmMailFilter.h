...
public:
	...
	BmMailFilter(const BmString& name, BmFilter* filter, bool executeInMem = false,
		bool needControllers = true);
...
private:
	...
	bool ExecuteFilter(BmMail* mail, BmFilter* filter, BmMsgContext* msgContext);
