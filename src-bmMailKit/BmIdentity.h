...
public:
	...
	inline const BmString& RecvAccount() const { return mRecvAccount; }
	...
	inline const BmString& SpecialHeaders() const { return mSpecialHeaders; }
...
public:
	...
	// native methods:
	void FindIdentitiesForRecvAccount(const BmString accName, BmIdentityVect& identities);
