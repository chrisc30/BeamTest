...
public:
	BmBackedFile() {}
	BmBackedFile(const char* filename, const char* mimetype = NULL, const BEntry* = NULL);
	BmBackedFile(const BEntry& entry, const char* mimetype = NULL, const BEntry* = NULL);
	~BmBackedFile();
	status_t SetTo(const char* filename, const char* mimetype = NULL, const BEntry* = NULL);
	status_t SetTo(const BEntry& entry, const char* mimetype = NULL, const BEntry* = NULL);
