...
\*------------------------------------------------------------------------------*/
static void
EncodeFlAndCheck(BmString input, BmString result)
{
	BmString encodedStr;
	int32 blockSize = 128;
...
FoldedLineEncoderTest::SimpleTest()
{
	...
	NextSubTest();
	EncodeFlAndCheck("A sentence with no encoded chars.", "A sentence with no encoded chars.");
}
...
FoldedLineEncoderTest::MultiLineTest()
{
	...
	NextSubTest();
	EncodeFlAndCheck("Vor meinen Fenster fängt es \ran sich zu bewegen",
		//
	...
	NextSubTest();
	EncodeFlAndCheck("1234567890123456789012345678901234567890123456789012345678901234567890",
		//
		"1234567890123456789012345678901234567890123456789012345678901234567890");
	// check wrapping near border at 76 characters:
	NextSubTest();
	EncodeFlAndCheck("12345678901234567890123456789012345678901234567890123456789012345678901",
		//
		"1234567890123456789012345678901234567890123456789012345678901234567890"
		"\r\n"
		" 1");
	...
	NextSubTest();
	EncodeFlAndCheck("123456789012345678901234567890123456789012345678901234567890123456789 ",
		//
