...
MultiLockerTest::suite()
{
	...
	suite->addTest(new CppUnit::TestCaller<MultiLockerTest>(
		"MultiLockerTest::BasicReadLockTest", &MultiLockerTest::BasicReadLockTest));

	// simple test for write-locking:
	suite->addTest(new CppUnit::TestCaller<MultiLockerTest>(
		"MultiLockerTest::BasicWriteLockTest", &MultiLockerTest::BasicWriteLockTest));

	// test for read-lock nesting:
	suite->addTest(new CppUnit::TestCaller<MultiLockerTest>(
		"MultiLockerTest::ReadLockNestTest", &MultiLockerTest::ReadLockNestTest));

	// test for write-lock nesting:
	suite->addTest(new CppUnit::TestCaller<MultiLockerTest>(
		"MultiLockerTest::WriteLockNestTest", &MultiLockerTest::WriteLockNestTest));

	// read-locks can pass one another:
	test = new MultiLockerTest;
	caller = new BThreadedTestCaller<MultiLockerTest>("MultiLockerTest::ReadLockPassTest", test);
	...
	test = new MultiLockerTest;
	caller = new BThreadedTestCaller<MultiLockerTest>("MultiLockerTest::WriteLockBlockTest", test);
	...
	test = new MultiLockerTest;
	caller = new BThreadedTestCaller<MultiLockerTest>("MultiLockerTest::MassiveReadLockTest", test);
	...
	test = new MultiLockerTest;
	caller
		= new BThreadedTestCaller<MultiLockerTest>("MultiLockerTest::ReadWriteLockBlockTest", test);
