...
public:
	...
	virtual bool AskUserForPopAcc(const BmString& accName, BmString& popAccName) = 0;
	...
	virtual int32 ShowAlert(
		const BmString& text, const char* btn1, const char* btn2, const char* btn3)
		= 0;
};
