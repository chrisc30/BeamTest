...
public:
	...
	BmString& Insert(const char*, int32 fromOffset, int32 length, int32 pos);

	BmString& Insert(const BmString&, int32 pos);
	BmString& Insert(const BmString&, int32 length, int32 pos);
	BmString& Insert(const BmString&, int32 fromOffset, int32 length, int32 pos);
	...
	BmString& ReplaceAll(char replaceThis, char withThis, int32 fromOffset = 0);
	BmString& Replace(char replaceThis, char withThis, int32 maxReplaceCount, int32 fromOffset = 0);
	...
	BmString& ReplaceAll(const char* replaceThis, const char* withThis, int32 fromOffset = 0);
	BmString& Replace(
		const char* replaceThis, const char* withThis, int32 maxReplaceCount, int32 fromOffset = 0);

	BmString& IReplaceFirst(char replaceThis, char withThis);
	BmString& IReplaceLast(char replaceThis, char withThis);
	BmString& IReplaceAll(char replaceThis, char withThis, int32 fromOffset = 0);
	BmString& IReplace(
		char replaceThis, char withThis, int32 maxReplaceCount, int32 fromOffset = 0);
	...
	BmString& IReplaceAll(const char* replaceThis, const char* withThis, int32 fromOffset = 0);
	BmString& IReplace(
		const char* replaceThis, const char* withThis, int32 maxReplaceCount, int32 fromOffset = 0);
	...
	BmString& CharacterEscape(
		const char* original, const char* setOfCharsToEscape, char escapeWith);
...
public:
	...
	BmString& ConvertTabsToSpaces(int32 numSpaces, const BmString* srcData = NULL);
	BmString& DeUrlify();
