...
bool
BmRosterBase::IsSupportedEmailMimeType(const BmString& mimetype)
{
	return mimetype.ICompare("text/x-email") == 0 || mimetype.ICompare("message/rfc822") == 0
...
BLooper*
BmGuiRosterBase::JobMetaController()
{
